...
dependencies {
    intellijPlatform {
        ...
        // IntelliJ Platform Gradle Plugin Dependencies - https://plugins.jetbrains.com/docs/intellij/tools-intellij-platform-gradle-plugin-dependencies-extension.html
